...
scoreboard players set in1 math 46
...
execute if score out math matches 0..42 run item modify entity @s weapon.mainhand toolmodifiers:modified_lore
...
execute if score out math matches 25 run item modify entity @s weapon.mainhand toolmodifiers:movement_speed_large
...
execute if score out math matches 26 run item modify entity @s weapon.mainhand toolmodifiers:movement_speed_large_neg
...
execute if score out math matches 41 run item modify entity @s weapon.mainhand toolmodifiers:attack_damage_small_neg
execute if score out math matches 41 run item modify entity @s weapon.mainhand toolmodifiers:attack_speed_small_neg
execute if score out math matches 41 run item modify entity @s weapon.mainhand toolmodifiers:movement_speed_large_neg
